...
/**
 * Updates the Tryitout with Major League Wiffleball project page with new content
 */
async function updateTryitoutMLW() {
  try {
    console.log('Updating Tryitout with Major League Wiffleball content...');
    ...
    // Update metadata: Role field (keeping the same content)
    htmlContent = htmlContent.replace(

 ...
 * This script combines metadata, main content, and timeline updates
 */
async function updateThackwayMcCordContent() {
  try {
    console.log('Updating Thackway McCord Pets project content...');
    ...
    // 1. Update metadata: Add Agency field
    ...
    // 3. Update each timeline item
    console.log('Updating timeline items...');
    
    // 3.1. Concept development & creative direction
    htmlContent = htmlContent.replace(
    ...
    // 3.2. QR code illustration & development
    htmlContent = htmlContent.replace(
    ...
    // 3.3. Packaging design & typography
    htmlContent = htmlContent.replace(
    ...
    // 3.4. Animation & digital experience
    htmlContent = htmlContent.replace(
    ...
    // 3.5. Companion stickers & physical assets
    htmlContent = htmlContent.replace(
    ...
    // 3.6. Social media & campaign extension
    htmlContent = htmlContent.replace(

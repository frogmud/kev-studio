...
async function updateThackwayMcCordPetsContent() {
  try {
    ...
    // Update packaging section with the new content
    htmlContent = htmlContent.replace(
      /<div class="timeline-item">\s*<h3>Packaging design & typography<\/h3>\s*<p>The chocolate bar packaging was designed to highlight the illustrated QR codes[\s\S]*?<\/p>/,
    ...
    console.log('Successfully updated thackway_mccord_pets.html with new packaging description');

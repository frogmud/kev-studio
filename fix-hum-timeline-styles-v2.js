...
async function updateHumTimelineStyles() {
  ...
  try {
    ...
    // Replace the timeline styles with the exact styles from other project pages
    htmlContent = htmlContent.replace(
      /<style>\s*\/\* Timeline styles for project pages \*\/.*?<\/style>/s,
      `<style>
    ...
    console.log('Successfully updated Hum timeline styles to match other projects.');
